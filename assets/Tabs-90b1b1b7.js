import{v as lt,a as dt}from"./runtime-dom.esm-bundler-3825b271.js";import{ag as ct,z as G,Q as ft,e as bt,t as ut,f as r,g as m,j as T,k as I,a3 as vt,u as pt,h as Re,n as B,i as ht,$ as ue,a1 as X}from"./light-a4b7478e.js";import{d as K,b as $,h as d,i as Ce,c as Y,ah as gt,F as mt,v as Q,p as xt,bc as F,g as yt,n as Z,w as wt,as as Rt}from"./runtime-core.esm-bundler-b2c41dc4.js";import{i as Ct,a as St,N as Tt}from"./Card-25731fbe.js";import{A as zt}from"./Add-f7f7f1e1.js";import{r as $t}from"./render-ae2c70c2.js";import{o as Pt}from"./omit-b0e7e098.js";import{t as _t}from"./light-ad9434f6.js";import{u as ve}from"./use-compitable-d780974b.js";import{f as ee}from"./flatten-c427e247.js";import{u as Wt}from"./use-merged-state-950900ad.js";import{c as At,a as pe,o as Lt}from"./cssr-f33a4f78.js";import{V as he}from"./VResizeObserver-83b1dbc1.js";const Bt=pe(".v-x-scroll",{overflow:"auto",scrollbarWidth:"none"},[pe("&::-webkit-scrollbar",{width:0,height:0})]),Et=K({name:"XScroll",props:{disabled:Boolean,onScroll:Function},setup(){const e=$(null);function n(s){!(s.currentTarget.offsetWidth<s.currentTarget.scrollWidth)||s.deltaY===0||(s.currentTarget.scrollLeft+=s.deltaY+s.deltaX,s.preventDefault())}const o=ct();return Bt.mount({id:"vueuc/x-scroll",head:!0,anchorMetaName:At,ssr:o}),Object.assign({selfRef:e,handleWheel:n},{scrollTo(...s){var x;(x=e.value)===null||x===void 0||x.scrollTo(...s)}})},render(){return d("div",{ref:"selfRef",onScroll:this.onScroll,onWheel:this.disabled?void 0:this.handleWheel,class:"v-x-scroll"},this.$slots)}});var kt=/\s/;function jt(e){for(var n=e.length;n--&&kt.test(e.charAt(n)););return n}var It=/^\s+/;function Ot(e){return e&&e.slice(0,jt(e)+1).replace(It,"")}var ge=0/0,Ft=/^[-+]0x[0-9a-f]+$/i,Ht=/^0b[01]+$/i,Dt=/^0o[0-7]+$/i,Mt=parseInt;function me(e){if(typeof e=="number")return e;if(Ct(e))return ge;if(G(e)){var n=typeof e.valueOf=="function"?e.valueOf():e;e=G(n)?n+"":n}if(typeof e!="string")return e===0?e:+e;e=Ot(e);var o=Ht.test(e);return o||Dt.test(e)?Mt(e.slice(2),o?2:8):Ft.test(e)?ge:+e}var Nt=function(){return ft.Date.now()};const te=Nt;var Vt="Expected a function",Ut=Math.max,Xt=Math.min;function Yt(e,n,o){var b,s,x,u,c,v,y=0,S=!1,p=!1,h=!0;if(typeof e!="function")throw new TypeError(Vt);n=me(n)||0,G(o)&&(S=!!o.leading,p="maxWait"in o,x=p?Ut(me(o.maxWait)||0,n):x,h="trailing"in o?!!o.trailing:h);function R(g){var W=b,k=s;return b=s=void 0,y=g,u=e.apply(k,W),u}function C(g){return y=g,c=setTimeout(_,n),S?R(g):u}function A(g){var W=g-v,k=g-y,O=n-W;return p?Xt(O,x-k):O}function z(g){var W=g-v,k=g-y;return v===void 0||W>=n||W<0||p&&k>=x}function _(){var g=te();if(z(g))return f(g);c=setTimeout(_,A(g))}function f(g){return c=void 0,h&&b?R(g):(b=s=void 0,u)}function w(){c!==void 0&&clearTimeout(c),y=0,b=v=s=c=void 0}function E(){return c===void 0?u:f(te())}function M(){var g=te(),W=z(g);if(b=arguments,s=this,v=g,W){if(c===void 0)return C(v);if(p)return clearTimeout(c),c=setTimeout(_,n),R(v)}return c===void 0&&(c=setTimeout(_,n)),u}return M.cancel=w,M.flush=E,M}var Gt="Expected a function";function ae(e,n,o){var b=!0,s=!0;if(typeof e!="function")throw new TypeError(Gt);return G(o)&&(b="leading"in o?!!o.leading:b,s="trailing"in o?!!o.trailing:s),Yt(e,n,{leading:b,maxWait:n,trailing:s})}const oe=bt("n-tabs"),Se={tab:[String,Number,Object,Function],name:{type:[String,Number],required:!0},disabled:Boolean,displayDirective:{type:String,default:"if"},closable:{type:Boolean,default:void 0},tabProps:Object,label:[String,Number,Object,Function]},fa=K({__TAB_PANE__:!0,name:"TabPane",alias:["TabPanel"],props:Se,setup(e){const n=Ce(oe,null);return n||ut("tab-pane","`n-tab-pane` must be placed inside `n-tabs`."),{style:n.paneStyleRef,class:n.paneClassRef,mergedClsPrefix:n.mergedClsPrefixRef}},render(){return d("div",{class:[`${this.mergedClsPrefix}-tab-pane`,this.class],style:this.style},this.$slots)}}),Kt=Object.assign({internalLeftPadded:Boolean,internalAddable:Boolean,internalCreatedByPane:Boolean},Pt(Se,["displayDirective"])),re=K({__TAB__:!0,inheritAttrs:!1,name:"Tab",props:Kt,setup(e){const{mergedClsPrefixRef:n,valueRef:o,typeRef:b,closableRef:s,tabStyleRef:x,tabChangeIdRef:u,onBeforeLeaveRef:c,triggerRef:v,handleAdd:y,activateTab:S,handleClose:p}=Ce(oe);return{trigger:v,mergedClosable:Y(()=>{if(e.internalAddable)return!1;const{closable:h}=e;return h===void 0?s.value:h}),style:x,clsPrefix:n,value:o,type:b,handleClose(h){h.stopPropagation(),!e.disabled&&p(e.name)},activateTab(){if(e.disabled)return;if(e.internalAddable){y();return}const{name:h}=e,R=++u.id;if(h!==o.value){const{value:C}=c;C?Promise.resolve(C(e.name,o.value)).then(A=>{A&&u.id===R&&S(h)}):S(h)}}}},render(){const{internalAddable:e,clsPrefix:n,name:o,disabled:b,label:s,tab:x,value:u,mergedClosable:c,style:v,trigger:y,$slots:{default:S}}=this,p=s??x;return d("div",{class:`${n}-tabs-tab-wrapper`},this.internalLeftPadded?d("div",{class:`${n}-tabs-tab-pad`}):null,d("div",Object.assign({key:o,"data-name":o,"data-disabled":b?!0:void 0},gt({class:[`${n}-tabs-tab`,u===o&&`${n}-tabs-tab--active`,b&&`${n}-tabs-tab--disabled`,c&&`${n}-tabs-tab--closable`,e&&`${n}-tabs-tab--addable`],onClick:y==="click"?this.activateTab:void 0,onMouseenter:y==="hover"?this.activateTab:void 0,style:e?void 0:v},this.internalCreatedByPane?this.tabProps||{}:this.$attrs)),d("span",{class:`${n}-tabs-tab__label`},e?d(mt,null,d("div",{class:`${n}-tabs-tab__height-placeholder`}," "),d(St,{clsPrefix:n},{default:()=>d(zt,null)})):S?S():typeof p=="object"?p:$t(p??o)),c&&this.type==="card"?d(Tt,{clsPrefix:n,class:`${n}-tabs-tab__close`,onClick:this.handleClose,disabled:b}):null))}}),qt=r("tabs",`
