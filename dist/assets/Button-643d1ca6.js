import{f as _,a2 as ze,j as b,I as Be,K as re,e as Se,g,k as d,a3 as Z,h as te,u as Te,l as Pe,n as t,M as W,i as ke,$ as ee,a4 as He,a1 as Re}from"./light-a4b7478e.js";import{a as Ee,c as We,u as Ie,N as Fe,b as _e}from"./browser-e8121bf8.js";import{i as Oe}from"./is-browser-fc34c9a6.js";import{u as je}from"./use-memo-3ef194ef.js";import{b as De}from"./light-6b66b35a.js";import{c as oe}from"./color-to-class-b0332f36.js";import{d as q,h as y,bc as Ne,b as k,a as Le,n as Ke,i as Me,c as I}from"./runtime-core.esm-bundler-b2c41dc4.js";import{a as Ae,T as Ge}from"./runtime-dom.esm-bundler-3825b271.js";const Ve=q({name:"FadeInExpandTransition",props:{appear:Boolean,group:Boolean,mode:String,onLeave:Function,onAfterLeave:Function,onAfterEnter:Function,width:Boolean,reverse:Boolean},setup(e,{slots:v}){function m(r){e.width?r.style.maxWidth=`${r.offsetWidth}px`:r.style.maxHeight=`${r.offsetHeight}px`,r.offsetWidth}function c(r){e.width?r.style.maxWidth="0":r.style.maxHeight="0",r.offsetWidth;const{onLeave:h}=e;h&&h()}function x(r){e.width?r.style.maxWidth="":r.style.maxHeight="";const{onAfterLeave:h}=e;h&&h()}function O(r){if(r.style.transition="none",e.width){const h=r.offsetWidth;r.style.maxWidth="0",r.offsetWidth,r.style.transition="",r.style.maxWidth=`${h}px`}else if(e.reverse)r.style.maxHeight=`${r.offsetHeight}px`,r.offsetHeight,r.style.transition="",r.style.maxHeight="0";else{const h=r.offsetHeight;r.style.maxHeight="0",r.offsetWidth,r.style.transition="",r.style.maxHeight=`${h}px`}r.offsetWidth}function P(r){var h;e.width?r.style.maxWidth="":e.reverse||(r.style.maxHeight=""),(h=e.onAfterEnter)===null||h===void 0||h.call(e)}return()=>{const r=e.group?Ae:Ge;return y(r,{name:e.width?"fade-in-width-expand-transition":"fade-in-height-expand-transition",mode:e.mode,appear:e.appear,onEnter:O,onAfterEnter:P,onBeforeLeave:m,onLeave:c,onAfterLeave:x},v)}}}),qe=_("base-wave",`
 position: absolute;
 left: 0;
 right: 0;
 top: 0;
...
`),Qe=q({name:"BaseWave",props:{clsPrefix:{type:String,required:!0}},setup(e){ze("-base-wave",qe,Ne(e,"clsPrefix"));const v=k(null),m=k(!1);let c=null;return Le(()=>{c!==null&&window.clearTimeout(c)}),{active:m,selfRef:v,play(){c!==null&&(window.clearTimeout(c),m.value=!1,c=null),Ke(()=>{var x;(x=v.value)===null||x===void 0||x.offsetHeight,m.value=!0,c=window.setTimeout(()=>{m.value=!1,c=null},1e3)})}}},render(){const{clsPrefix:e}=this;return y("div",{ref:"selfRef","aria-hidden":!0,class:[`${e}-base-wave`,this.active&&`${e}-base-wave--active`]})}}),{cubicBezierEaseInOut:$}=Be;function Xe({duration:e=".2s",delay:v=".1s"}={}){return[b("&.fade-in-width-expand-transition-leave-from, &.fade-in-width-expand-transition-enter-to",{opacity:1}),b("&.fade-in-width-expand-transition-leave-to, &.fade-in-width-expand-transition-enter-from",`
 ...
 `,[g("active",{zIndex:1,animationName:"button-wave-spread, button-wave-opacity"})]),Oe&&"MozBoxSizing"in document.createElement("div").style?b("&::moz-focus-inner",{border:0}):null,d("border, state-border",`
 position: absolute;
 left: 0;
 top: 0;
 right: 0;
 ...
 align-items: center;
 justify-content: center;
 `,[Ee({top:"50%",originalTransform:"translateY(-50%)"})]),Xe()]),d("content",`
 display: flex;
 align-items: center;
 flex-wrap: nowrap;
 min-width: 0;
